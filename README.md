# kube-etcd
This is essentially the BOSH [etcd](http://bosh.io/releases/github.com/cloudfoundry-incubator/etcd-release?all=1) release

Primary Changes are:
* The etcd job has been reconfigured to use BOSH 2.0 features like links.
* etcd spec file has changed in how properties are structured (all changes in jobs/etcd only)
* Using etcd version 3.0.10
